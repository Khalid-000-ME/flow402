...
Basic quote request [#basic-quote-request]
...
Client-side responsibilities [#client-side-responsibilities]
...
Critical Field: data [#critical-field-data]
...
Get quote with permit data [#get-quote-with-permit-data]
...
Sign the permit [#sign-the-permit]
...
Transaction revert scenarios [#transaction-revert-scenarios]
...
Quote freshness [#quote-freshness]
...
Slippage configuration [#slippage-configuration]
